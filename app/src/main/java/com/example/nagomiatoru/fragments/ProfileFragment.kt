...
import com.example.nagomiatoru.activities.PersonalInfoActivity
...
class ProfileFragment : Fragment() {
    ...
    private fun setupUIElements(view: View) {
        ...
        val name = SessionManager.getName() ?: "Andrew Ainsley"
        val email = SessionManager.getEmail() ?: "andrew.ainsley@yourdomain.com"
    ...
    private fun setupPersonalInfoClick(view: View) {
        val layout = view.findViewById<LinearLayout>(R.id.layout_personal_info)
    ...
    override fun onResume() {
        super.onResume()
        // Actualizar los datos del usuario cuando regrese a este fragmento
        view?.let { v ->
            val tvUserName = v.findViewById<TextView>(R.id.tv_user_name)
            val tvUserEmail = v.findViewById<TextView>(R.id.tv_user_email)
